   ...
   YAHOO.extend(Alfresco.component.ManagePermissions, Alfresco.component.Base,
   {
      ...
      onAuthorityFinderLoaded: function Permissions_onAuthorityFinderLoaded(response)
      {
         ...
         if (finderDiv)
         {
            ...
            {
                //RRD - added site parameter to authority-query URL
               dataWebScript: Alfresco.constants.URL_SERVICECONTEXT + "components/people-finder/authority-query?siteId="+this.options.site,
