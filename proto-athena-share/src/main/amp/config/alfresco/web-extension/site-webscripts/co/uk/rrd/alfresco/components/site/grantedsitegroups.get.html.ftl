<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link href="${url.context}/res/components/site/grantedsitegroups.css"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script src="${url.context}/res/components/site/grantedsitegroups.js" />
</@>
         ...
         <div id="${args.htmlid}-groupslist" class="groupslist">
            <#-- div id="${args.htmlid}-invitationBar" class="invitelist-bar">
               <#list groups as group>
                  <option value="${group}">${msg('group.' + group)}</option>
               </#list>
               </select>
            </div -->
